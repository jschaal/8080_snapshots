Attribute VB_Name = "CompilerAdvanced"

'==============================================================================
' Module: CompilerAdvanced (Updated for Class-Based Architecture)
...
Private Function GetSelectedCPU() As String
    ...
    GetSelectedCPU = CStr(Range("CPUMode").value)
    On Error GoTo 0
        ...
        Select Case opcode
            ...
            Case "DS"
                ...
                If Not usrValIsHexString(cur.offset(0, ofsOp1).value) Then
                    cmpRaiseAsmError wsCPU, "DS Invalid length", cur
                    Exit Sub
                End If
            ...
            Case Else
                ...
                If IsEmpty(info) Then
                    cmpRaiseAsmError wsCPU, "Unknown instruction: " & opcode & " " & op1 & " " & op2, cur
                    Exit Sub
                End If
